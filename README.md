...
- [x] Explain what a token is used for.
        A. A peice of data that can be used in Authentication for Applications
- [x] What steps can you take in your web apps to keep your data secure?
        A. You can create a login page that is based on identifying users. 
- [x] Describe how web servers work.
        A. They take data that is stored and allow them to be displayed on the WWW.  The data can be anything from a simple application to secure data that can be manipulated.
